...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN FAN1_PIN   //RLND FAN2_PIN       // Set a custom pin for the controller fan
 ...
 */
#define E0_AUTO_FAN_PIN FAN2_PIN    //RLND FAN1_PIN
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD   //RLND uncommented
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -1.0    //RLND uncommented -4.0
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.45  //RLND 0.0         // (mm) Compression length applying to all extruders
  #endif
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS //RLND uncommented
